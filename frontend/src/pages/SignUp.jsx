...
const SignUp = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.confirmPassword) {
      ...
      newErrors.confirmPassword = VALIDATION_MESSAGES.passwordMatch;
    }
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          if (result.success) {         
            ...
            setLoginError(result.error || 'Failed to sign Up. Please check your credentials.');
          }
        }, 3000);
      } else {
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-[#8A8D93]">Join the Nyx Cipher ecosystem</p>
          </div>
          ...
          {signupSuccess && (
            <div className="bg-[#00CC9A]/10 border border-[#00CC9A] text-[#00CC9A] px-4 py-3 rounded-md mb-6">
              {signupSuccess}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center">
              <input
                ...
                required
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-[#8A8D93]">
                I agree to the <a href="#" className="text-[#00E8FF] hover:underline">Terms of Service</a> and <a href="#" className="text-[#00E8FF] hover:underline">Privacy Policy</a>
              </label>
            </div>
            ...
            <div className="text-center mt-4">
              <span className="text-[#8A8D93]">Already have an account? </span>
              <Link to="/signin" className="text-[#00E8FF] hover:underline">
                Sign In
              </Link>
            </div>
          </form>
